...
import sys, time, os, urllib.request, urllib.error, urllib.parse, shelve, string, xmltramp, email.generator, mimetypes, hashlib, webbrowser
...
### MODO DE USO
## $ ./uploader.py /path.to.pics/ "nombre(s)" "descripcion" "tags"
## las tags separadas por comas
